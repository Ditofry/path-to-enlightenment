...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_a_character_class_can_be_negated
    # You still get the other chars because the + is in play
  ...
  def test_slash_b_anchors_to_a_word_boundary
    # notice the dot (which is any character.)
  ...
  def test_variables_can_also_be_used_to_access_captures
    # NOTICE the comma and the white space.... this isn't an array, its
    # part of the regular expression.  Don't be fooled...
